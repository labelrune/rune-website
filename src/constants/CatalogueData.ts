...
export const CatalogueData: CatalogueDataType[] = [
  {
    ...
    title: "Nyah",
    description: "A pleated Chanderi silhouette in cobalt blue, paired with a scalloped organza dupatta.Floral embroidery on the bodice adds delicate charm to this festive classic. Material Kurta: Chanderi Dupatta: Pure Organza Length - Top wear : 58 inches",
    imageUrl: [
